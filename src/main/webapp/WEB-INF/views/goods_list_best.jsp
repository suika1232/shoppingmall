...
#title{font-size:30px;width:300px;height:130px;border:1px solid black;margin:0 auto;cursor:pointer}
...
<div style="text-align:center">
	<div id="title"><h1>best sellers</h1></div>
</div>
...
function printBestProducts(){
	
	
	// td 의 개수는 data length 만큼 필요함. 
	
	$.ajax({url:'/getBestProducts', type:'post', dataType:'json', 
