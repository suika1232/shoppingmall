...
nav{
     ...
     min-width:1250px; font-family: 'Noto Sans KR', sans-serif;
}
nav a{color:white;}
aside{
     height: 400px; width: 13%; text-align: left; 
     float: left ; margin-top: 20px; position: sticky; top: 40px; left: 20px ;margin-bottom:200px;z-index: 1;
} 
section{
     height: 100%;width:100%; text-align: center; margin-bottom: 0px;
